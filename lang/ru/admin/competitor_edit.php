...
$MESS['KK_PRICEWATCH_EDIT_DOMAIN_HINT'] = 'Разрешённый хост для HTTP-сбора (например, royal-computers.ru); URL товаров не изменяются.';
$MESS['KK_PRICEWATCH_EDIT_TYPE'] = 'Тип коллектора';
$MESS['KK_PRICEWATCH_EDIT_HANDLER'] = 'Обработчик';
$MESS['KK_PRICEWATCH_EDIT_HANDLER_HINT'] = 'Зарезервировано для будущих коллекторов; для http обычно пусто.';
$MESS['KK_PRICEWATCH_EDIT_OPTIONS'] = 'Параметры коллектора';
$MESS['KK_PRICEWATCH_EDIT_OPTIONS_HINT'] = 'JSON; для http: {"price_selector":{"type":"xpath","value":"//REPLACE_WITH_VERIFIED_PRICE_NODE"},"currency":"RUB"}';
