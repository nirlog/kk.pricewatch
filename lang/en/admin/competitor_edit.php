...
$MESS['KK_PRICEWATCH_EDIT_DOMAIN_HINT'] = 'Allowed hostname for HTTP collection (for example, royal-computers.ru); product URLs are not changed.';
$MESS['KK_PRICEWATCH_EDIT_TYPE'] = 'Collector type';
$MESS['KK_PRICEWATCH_EDIT_HANDLER'] = 'Handler';
$MESS['KK_PRICEWATCH_EDIT_HANDLER_HINT'] = 'Reserved for future collectors; normally empty for http.';
$MESS['KK_PRICEWATCH_EDIT_OPTIONS'] = 'Collector options';
$MESS['KK_PRICEWATCH_EDIT_OPTIONS_HINT'] = 'JSON; for http: {"price_selector":{"type":"xpath","value":"//REPLACE_WITH_VERIFIED_PRICE_NODE"},"currency":"RUB"}';
